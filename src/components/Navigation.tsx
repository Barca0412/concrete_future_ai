        ...
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            <div className="flex items-center gap-1.5">
              <span 
                className="text-2xl font-extrabold text-gray-900 transition-colors duration-300 group-hover:text-[#F97316]"
                style={{ 
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button 
              ...
              className="ml-6 px-6 py-2 rounded-full text-sm text-white font-bold transition-all duration-300 shadow-lg shadow-orange-200/50 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-orange-200/60"
              style={{
          ...
          <div className="md:hidden flex items-center gap-3">
            ...
            <button 
              onClick={() => setIsModalOpen(true)}
              className="px-4 py-1.5 rounded-full text-xs text-white font-bold transition-all duration-300 shadow-md shadow-orange-200/50"
              style={{
                backgroundColor: '#F97316',
                fontFamily: 'var(--font-display)'
              }}
            ...
            <button
              ...
              style={{
                background: isMenuOpen ? 'rgba(249, 115, 22, 0.1)' : 'transparent',
                color: isMenuOpen ? '#F97316' : '#4B5563'
              }}
            >
